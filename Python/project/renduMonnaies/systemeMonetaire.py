class GestionMonetaire:
    ...
    def set_compte_exemple(self) -> None:
        self._compte = {1: 100, 2: 100, 5: 100, 10: 100, 20: 100, 50: 100, 100: 100}
    
    def check_compte(self, id:int) -> bool:
    ...
    def renduMonnaies(self, somme_a_rendr) -> dict:
        ...
        while somme_a_rendr > 0:
            print
            if idPiece < 0:
                print("plus de moulla dans les caisse") 
